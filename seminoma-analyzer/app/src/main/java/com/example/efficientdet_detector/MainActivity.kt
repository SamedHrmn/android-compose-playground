...
import com.example.seminoma_analyzer.ui.common.DrawBoundingBox
import com.example.seminoma_analyzer.ui.common.ScaffoldSheetContent
import com.example.seminoma_analyzer.ui.theme.SeminomaanalyzerTheme
...
fun CameraPreviewWithDetection(activity:Activity){
    ...
    CameraPreviewUI(previewView = previewView, detection = detection.value)
}
...
@Composable
fun CameraPreviewUI(previewView: PreviewView, detection: Detection?){
    PageScaffold(
        content = {
...
@Composable
fun PageScaffold(content: @Composable () -> Unit) {
    ...
    BottomSheetScaffold(
        ...
        sheetContent = {
            ScaffoldSheetContent(scaffoldSheetState)
        }
